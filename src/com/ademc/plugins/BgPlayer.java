...
public class BgPlayer extends CordovaPlugin implements AudioManager.OnAudioFocusChangeListener {
  ...
  public void onAudioFocusChange(int focusChange) {
    if (focusChange <= 0) {
      ...
      //GAIN -> PLAY
      //if we know player service was running before, you should uncomment this line
      //this.startService();
    }
  }
}
